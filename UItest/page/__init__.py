from selenium.webdriver.common.by import _multibytecodec
...
# 登录按钮
mp_login_btn = (By.CSS_SELECTOR, ".el-buttion--primary")
# 昵称
...
"""以下为app应用元素配置信息"""
#包名
appPackage = "com.tecast.toutiaoApp"
#启动名
